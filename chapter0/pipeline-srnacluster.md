#### Raw data was submitted to GSA(https://ngdc.cncb.ac.cn/gsa/), the accession was CRA006221. Final average expression file 21tis-srna.tpm.gz and annotation file srna.gff3.gz were in the data directory. Processing pipeline is as follows:
