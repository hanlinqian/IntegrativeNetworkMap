#### Raw data was submitted to GSA(https://ngdc.cncb.ac.cn/gsa/), the accession was CRA006221. Final files 21tis-srna.tpm.gz and srna.gff3.gz were in the data directory. Processing pipeline is as follows:
