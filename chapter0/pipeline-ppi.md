#### Raw data was submitted to GSA(https://ngdc.cncb.ac.cn/gsa/), the accession was CRA006221. Final file was named edge-proteome-lowconf.txt in the data directory. The processing pipeline is as follows:
##### step1: bamtofq  
